...
// Because node and nodelet usually offer the same functionality, the nodelet test is only here to
// test
// whether the nodelet starts and stops correcly. All the unittests can go to the node test.

TEST(demo_image_processing_ros_tool, pylon_detector_test_initialization) {
...
int main(int argc, char** argv) {
    ...
    ros::init(argc, argv, "pylon_detector_nodelet_test");
